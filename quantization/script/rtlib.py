#@author windfly 2018-4-1
#@email hxwkuangfu936@163.com
import urllib3
import ssl
import json
import time
       ...
       attribute_history(context, bars, fields)
           ...
           Inputs:
               context: 上下文数据内容，包含：
                        ...
                        单位时间长度, 几天或者几分钟, 现在支持 1：1分钟；
                        2：3分钟；3：5分钟；4：15分钟；5：30分钟；6：1小时；7：2小时；8：4小时；9：1日；10：1周；11：1月
               count: 数量, 返回的结果集的行数
